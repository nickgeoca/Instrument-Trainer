    ...
    d_timerId(-1)
{
    ...
    setAxisTitle(QwtPlot::yLeft, "Frequency [Hz]");
    setAxisScale(QwtPlot::yLeft, 150, 700);
    ...
    _pen_data = new QPen();
    _pen_data->setWidth(5);
    _pen_data->setColor(Qt::red);
    d_curve->setPen(*_pen_data);
#if 1
...
void Plot::setLineColor(QColor &color)
{
    _pen_data->setColor(color);
    d_curve->setPen(*_pen_data);
}
